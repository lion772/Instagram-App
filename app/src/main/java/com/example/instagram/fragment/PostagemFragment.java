...
public class PostagemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Validar permissões
        Permissao.validarPermissoes(permissoesNecessarias, getActivity(), 1 ); //Solicitar permissão também em AndroidManifest
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if( resultCode == getActivity().RESULT_OK ){ //Como é um fragment, é necessário colocar o getActivity()
