...
public class PerfilAmigoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            //Configura referência postagens usuario
        ...
        gridViewPerfil.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("postagem", postagem); //Para passar um objeto para outra activity, é preciso implementar a interface Serializable
    ...
    private void verificaSegueUsuarioAmigo(){
        ...
        DatabaseReference seguidorRef = seguidoresRef //acessar somente um seguidor no nó de seguidores
                .child( usuarioSelecionado.getId() )
                .child( idUsuarioLogado );

        seguidorRef.addListenerForSingleValueEvent( //executar uma única vez para consultar os dados e não queremos ficar "ouvindo" quaisquer alterações
                new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
